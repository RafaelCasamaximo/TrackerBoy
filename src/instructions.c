...
Instruction instructions[0x100] = {
    ...
    [0xE3] = {IN_ERR},                                      // Implemented
    [0xE4] = {IN_ERR},                                      // Implemented
    ...
    [0xEB] = {IN_ERR},                                      // Implemented
    [0xEC] = {IN_ERR},                                      // Implemented
    [0xED] = {IN_ERR},                                      // Implemented
    ...
    [0xFC] = {IN_ERR},                                      // Implemented
    [0xFD] = {IN_ERR},                                      // Implemented
